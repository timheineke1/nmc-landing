// app/page.tsx  (or page.tsx at your project root, wherever your current file lives)
"use client";
...
export default function NMCGradientPage() {
  ...
  return (
    <main className="relative min-h-screen font-mono text-[15px] leading-7 text-black">
      ...
      <div className="mx-auto max-w-2xl px-6 py-16">
        <div className="rounded-2xl bg-white/85 p-8 shadow-[0_0_1px_rgba(0,0,0,0.06)] backdrop-blur-sm">
          {/* Tiny logo row */}
          ...
          <section className="space-y-5">
            ...
            <p>
              We help shape your ideas and bring them to life in weeks instead of months. Work with us per project
              or as an extension of your team, like your own Labs.
            </p>

            <p>
              Sometimes we build things for ourselves—to show, not tell—and along the way, we might find the right
              partner to take it further. That could be a co-founder, an operator, or a music company ready to run
              with a working idea.
            </p>
          </section>
